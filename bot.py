...
import os
token = '7682157231:AAH_syLmPBkiLqwelZQ6V7-Hlx7-dZxyfts'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = ['5827732412', '2136231272', '1843312482']
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) in subscriber:
		bot.reply_to(message, "Only For team BLACKBOT 🔥")
		return
